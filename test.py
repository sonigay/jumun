...
async def on_message(message):
    ...
    if message.content == '!정책표':
        ...
        await client.send_message(client.get_channel("672022974223876096"), message.author.display_name + "(" + message.channel.name + message.author.id + ") : 정책표출력!! " + message.content[4:])
